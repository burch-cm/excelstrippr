...
The goal of metastrippr is to provide an easy way to remove the extraneous
metadata and extract the useful tabular data from Excel-based reports. 
...
## The Solution  
metastrippr will look for the start of a tabular data set in an Excel file, ignoring 
...
The most recent version of metastrippr can be installed from [GitHub](https://github.com/burch-cm/metastrippr) with {devtools}:  
``` r
